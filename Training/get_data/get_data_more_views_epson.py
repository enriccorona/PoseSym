...
def load_epson_views():
#  multiview_folder = '/ais/gobi5/enricproject/data_cnn/multiview_depth80/'
  multiview_folder = '/ais/gobi5/enricproject/data_cnn/multiview_epson/'
  #multiview_folder = '/ais/gobi5/enricproject/data_cnn/multiview_1296/' #336/'
#  multiview_folder = '/ais/gobi5/enricproject/data_cnn/multiview_336/'
  ...
  models = glob.glob(multiview_folder + 'Cropped_model_*.npy')
